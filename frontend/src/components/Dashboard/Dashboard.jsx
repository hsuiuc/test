...
class Dashboard extends Component {
    ...
    onSubmit(e){
      ...
      xhr.open("GET","https://longridesharing.herokuapp.com/api/rideInfo?where="+formData);
      xhr.onload = () =>{
    ...
    render() {
      ...
      if(this.state.decline){
        ...
        let url="https://longridesharing.herokuapp.com/api/rideInfo/"+this.state.thePassenger._id;
